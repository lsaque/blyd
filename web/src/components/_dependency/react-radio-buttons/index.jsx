  ...
  getStyles() {
    ...
    return {
      root: {
        ...
        borderWidth: 1,
        borderStyle: 'solid',
        borderColor: disabled ? (disabledColor || '#e1e1e1') : (rootColor || '#ECECEC'),
        padding: padding || 16,
        marginBottom: 10,
        // flex: 1,
      ...
      checked: {
        borderColor: pointColor || '#8363F6',
        color: pointColor || '#8363F6',
        backgroundColor: '#8363F630',
      },
    };
  }
  ...
  getStyles() {
    ...
    return {
      root: {
        ...
        borderRadius: '50%',
        borderStyle: 'solid',
        borderColor: disabled ? (disabledColor || '#e1e1e1') : (rootColor || '#e2e2e2'),
